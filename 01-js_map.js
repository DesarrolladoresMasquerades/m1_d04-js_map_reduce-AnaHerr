...
// const someCallbackFunction = ()=> {}
    ...
    const greetings = students.map ( (student)=> {
          return `Hello ${student.name}, you are ${student.age} years old and your favourite color is ${student.color}` 
    })
 
 console.log(greetings) //Will print everything in the function
